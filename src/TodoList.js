export default function TodoList(props) { // ...................... принимаем данные через props
    return (
        <section>  {/*...............................................корневой тэг */}
            <h1>Дела</h1>
            <table className="table is-hoverable is-fullwidth"> {/* ...... выводим таблицу с перечнем дел и задем стили через классы*/}
        {/*//is-hoverable - подстветка строкпри наведении мыши на строку. is-fullwidth - растянуть таблицу на всю ширину родителя**/}
                <tbody>
                 {props.list.map((item) => (
                    // .............................перебираем полученный массив с делами
                    <tr key={item.key}> {/*............................выводит строку таблицы*/}
                        <td>
